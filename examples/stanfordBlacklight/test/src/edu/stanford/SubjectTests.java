...
// TODO: this should NOT be true once we have bad Lane topics out of the topic field
	...
	/**
	 * Test population and properties of topic_full_search field
	 */
@Test
	public final void testTopicFullSearch() 
			throws ParserConfigurationException, IOException, SAXException 
	{
        createIxInitVars(testDataFname);
		String fldName = "topic_full_search";
		assertTextFieldProperties(fldName, solrCore, sis);
		assertFieldIndexed(fldName, solrCore);
		assertFieldNotStored(fldName, solrCore);
		assertFieldHasNorms(fldName, solrCore);
		...
		assertSingleResult("6808639", fldName, "\"880-04 Zhongguo gong chan dang Party work.\"", sis);  // 610-6
		assertSingleResult("4698973", fldName, "\"Flyby missions. nasat\"", sis);  // 650-2
		assertSingleResult("6553", fldName, "\"Municipal Fire Station records Fire Reports Atlanta Georgia 1978 thesaurus code\"", sis);  // 655-3
		assertSingleResult("6553", fldName, "Municipal Fire Station records atlanta georgia 1978 thesaurus code", sis);  
...
@Test
	...
	/**
	 * Test population of geographic_search field.
	 */
	@Test
	...
	/**
	 * Test multiple occurrences of geographic_full_search fields when there
...
@Test
	...
	{
        createIxInitVars(testDataFname);
		String fldName = "geographic_full_search";
		assertTextFieldProperties(fldName, solrCore, sis);
		assertFieldIndexed(fldName, solrCore);
		assertFieldNotStored(fldName, solrCore);
		assertFieldHasNorms(fldName, solrCore);
	...
	/**
	 * Test population of era_search field.  Trailing punctionation irrelevant
	 */
@Test
	public final void testEraSearch() 
			throws ParserConfigurationException, IOException, SAXException 
	{
		String fldName = "era_search";
