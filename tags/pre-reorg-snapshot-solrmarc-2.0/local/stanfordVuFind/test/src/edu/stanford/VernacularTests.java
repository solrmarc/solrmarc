...
@Test
			...
			throws ParserConfigurationException, IOException, SAXException 
	{
		...
		assertDocHasFieldValue("allVern", fldName, "contents", sis);
		assertZeroResults(fldName, "vernacular contents", sis);
	}
...
ps.println("DEBUG:  vern_full_title_display contains: " + getDocument("hebrew1", sis).getValues("vern_full_title_display")[0]);		
