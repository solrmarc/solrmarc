...
//    	return ((indexConfiguration.length() >= 3 && Utils.isNumber(indexConfiguration.trim().substring(0, 3)) ) ||
//                 (indexConfiguration.length() >= 6 && indexConfiguration.trim().substring(0, 3).equals("LNK") &&
