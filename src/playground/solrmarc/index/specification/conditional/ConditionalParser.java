...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu May 19 13:52:55 EDT 2016
  */
  ...
  public final java_cup.runtime.Symbol CUP$ConditionalParser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$ConditionalParser$act_num)
		...
		int s1left = ((java_cup.runtime.Symbol)CUP$ConditionalParser$stack.elementAt(CUP$ConditionalParser$top-3)).left;
		int s1right = ((java_cup.runtime.Symbol)CUP$ConditionalParser$stack.elementAt(CUP$ConditionalParser$top-3)).right;
		String s1 = (String)((java_cup.runtime.Symbol) CUP$ConditionalParser$stack.elementAt(CUP$ConditionalParser$top-3)).value;
		int s2left = ((java_cup.runtime.Symbol)CUP$ConditionalParser$stack.elementAt(CUP$ConditionalParser$top-2)).left;
		int s2right = ((java_cup.runtime.Symbol)CUP$ConditionalParser$stack.elementAt(CUP$ConditionalParser$top-2)).right;
		...
		int s3left = ((java_cup.runtime.Symbol)CUP$ConditionalParser$stack.peek()).left;
		int s3right = ((java_cup.runtime.Symbol)CUP$ConditionalParser$stack.peek()).right;
		...
		int fleft = ((java_cup.runtime.Symbol)CUP$ConditionalParser$stack.peek()).left;
		int fright = ((java_cup.runtime.Symbol)CUP$ConditionalParser$stack.peek()).right;
		...
		String p = (String)((java_cup.runtime.Symbol) CUP$ConditionalParser$stack.peek()).value;
		 RESULT = AbstractSpecificationFactory.makeSingleSpecification(f, null, p); 
          ...
          case 11: // field_spec_part_simple ::= FIELDSPEC SUBFIELDSPEC POSITION 
            {
              SingleSpecification RESULT =null;
		int fleft = ((java_cup.runtime.Symbol)CUP$ConditionalParser$stack.elementAt(CUP$ConditionalParser$top-2)).left;
		int fright = ((java_cup.runtime.Symbol)CUP$ConditionalParser$stack.elementAt(CUP$ConditionalParser$top-2)).right;
		String f = (String)((java_cup.runtime.Symbol) CUP$ConditionalParser$stack.elementAt(CUP$ConditionalParser$top-2)).value;
		int sfleft = ((java_cup.runtime.Symbol)CUP$ConditionalParser$stack.elementAt(CUP$ConditionalParser$top-1)).left;
		int sfright = ((java_cup.runtime.Symbol)CUP$ConditionalParser$stack.elementAt(CUP$ConditionalParser$top-1)).right;
