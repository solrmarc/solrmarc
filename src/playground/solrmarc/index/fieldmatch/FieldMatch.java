...
//    public String toString(String separator, String sfTagPattern, boolean cleanAll, boolean cleanEnd, String translationMapName)
//    {
...
//            {
//                TranslationMap map = TranslationMapFactory.theMaps.findMapFromSpec(translationMapName);
//                if (map != null)
...
//            Pattern subfieldPattern = Pattern.compile(spec.subfields.length() == 0 ? "." : spec.subfields);
...
//                    }
//                    buffer.append(cleanAll ? Utils.cleanData(subfield.getData().trim()) : subfield.getData().trim());
//                }
//            }
//            String result = cleanEnd ? Utils.cleanData(buffer.toString()) : buffer.toString();
...
//    public Collection<String> toStringSet(String separator, String sfTagPattern, boolean cleanAll, boolean cleanEnd)
//    {
//        if (vf instanceof ControlField)
//        {
//            String data = ((ControlField) vf).getData();
...
//            }
//            if (buffer.length() > 0)
//                return(cleanEnd ? Utils.cleanData(buffer.toString()) : buffer.toString());
//            else
//                return(null);
//        }
//    }
