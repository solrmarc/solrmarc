...
public class LoggerDelegator
{
    ...
    public static void reInit(String[] homeDirs)
    {
        ...
        for (int i = 0; i < j; i++)
        {
            ...
            if (log4jProps.exists())
            {
                Class<?> propManClazz;
                try {
                    propManClazz = Boot.classForName("org.apache.log4j.LogManager");
    ...
    public static void flushToLog()
    {
        try
        {
            ...
            {
                logger = LogManager.getLogger(msg[0].toString());
                ...
                Method logMethod = logger.getClass().getMethod("log", new Class[] { String.class, Boot.classForName("org.apache.log4j.Priority"), Object.class, Throwable.class });
