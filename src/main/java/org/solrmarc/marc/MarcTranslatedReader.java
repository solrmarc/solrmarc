...
public class MarcTranslatedReader implements MarcReader
{
 ...
 //   java.text.Normalizer.Mode unicodeNormalize = java.text.Normalizer.NONE;
    ...
    public MarcTranslatedReader(MarcReader r, boolean unicodeNormalizeBool)
    {
        ...
        if (unicodeNormalizeBool) this.unicodeNormalize = Normalizer.Form.NFC;
    }
    ...
    public MarcTranslatedReader(MarcReader r, String unicodeNormalizeStr)
    {
        reader = r;
        convert = new AnselToUnicode();
        if (unicodeNormalizeStr.equals("KC")) unicodeNormalize = Normalizer.Form.NFKC;
        else if (unicodeNormalizeStr.equals("KD")) unicodeNormalize = Normalizer.Form.NFKD;
        else if (unicodeNormalizeStr.equals("C")) unicodeNormalize = Normalizer.Form.NFC;
        else if (unicodeNormalizeStr.equals("D")) unicodeNormalize = Normalizer.Form.NFD;
        else unicodeNormalize = null;
    }
