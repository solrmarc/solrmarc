...
@Test
			...
			throws IOException 
	{
		...
		String bibFilePath =  commandLinePathPrefix + testDataParentPath + File.separator + "mhldMergeBibs46.mrc";
		String mhldFilePath =  commandLinePathPrefix + testDataParentPath + File.separator + "mhldMergeMhlds235.mrc";
